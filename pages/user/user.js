  ...
  onLoad() {
    ...
    let myList = [{
        ...
        },
        {
          ...
          name: "网大商城",
          page: "",
          iconBg: `/images/userIcon/shopIconBg.png`,
          icon: `/images/userIcon/shopIcon.png`,
          isMini: 1,
        ...
        },
        {
          ...
          name: "网大游学",
          page: "",
          icon: `${this.data.$state.imgHost}/userIcon/shopIcon2.png`,
          isMini: 1,
        ...
        },
        {
          ...
          icon: `${this.data.$state.imgHost}/userIcon/workIcon.png`,
        },
        // {
        //   id: 3,
        //   name: "我的关注",
